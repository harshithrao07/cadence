package com.cadence.playlist_service.filter;

import com.cadence.playlist_service.config.GatewaySecretProperties;
...
class InternalTrafficFilterTest {
    ...
    void validSecret_passesThrough() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v1/playlist/all");
    ...
    @Test
    void emptySecret_returns403() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v1/playlist/all");
