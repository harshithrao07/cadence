...
public class InternalTrafficFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (path.startsWith("/actuator/") || path.startsWith("/internal/") || path.startsWith("/auth/v1/authenticate") || path.startsWith("/auth/v1/register") || path.startsWith("/auth/v1/validateEmail") || path.startsWith("/auth/v1/refresh")) {
