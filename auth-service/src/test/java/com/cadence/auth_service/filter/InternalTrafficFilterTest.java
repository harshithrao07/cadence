...
class InternalTrafficFilterTest {
    ...
    void internalPath_passesThrough_withoutSecretCheck() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/internal/users/user-1/preview");
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    @Test
    void authAuthenticatePath_passesThrough_withoutSecretCheck() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/auth/v1/authenticate");
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    @Test
    void authRegisterPath_passesThrough_withoutSecretCheck() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/auth/v1/register");
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    @Test
    void authRefreshPath_passesThrough_withoutSecretCheck() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/auth/v1/refresh");
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    void validSecret_passesThrough() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v1/user/user-1");
